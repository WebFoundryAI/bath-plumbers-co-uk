...
- **Service-in-location pages** - Core SEO pages (e.g., "Blocked Drains in Bath")
- **Sub-service pages** - Granular service pages (e.g., "Blocked Toilet in Bath")
...
export const BRAND: BrandConfig = {
  ...
  serviceAreaLabel: "Bath and surrounding areas",
  phone: "0161 000 0000",
...
export const PRIMARY_LOCATION: LocationConfig = {
  slug: "bath",
  name: "Bath",
  countyOrRegion: "Somerset and Wiltshire",
  latitude: 51.3781,
  longitude: -2.3597,
};
...
2. **Update `wrangler.toml`:**
   ...
   [env.production]
   routes = [
     { pattern = "bathplumbers.co.uk/*", zone_id = "your-zone-id" }
   ]
   ```
...
curl -I https://bathplumbers.co.uk/services

# Should also return 200 (canonical URL already has /)
curl -I https://bathplumbers.co.uk/services/

# Should return 200 for all valid routes
curl -I https://bathplumbers.co.uk/locations/bath
curl -I https://bathplumbers.co.uk/blog
```
