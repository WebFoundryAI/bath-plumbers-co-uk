...
const CUSTOMER_REVIEWS = [
  ...
  },
  {
    ...
    reviewRating: 5,
    reviewBody: "Used Blocked Drains Bath for a CCTV survey after repeated drainage issues. They identified the root cause and provided a clear report with options. Very thorough and reasonably priced."
  },
  {
...
export function getBaseBusinessSchema() {
  return {
    ...
    "description": "Professional drain unblocking, CCTV surveys, and emergency drainage services across Bath and Somerset and Wiltshire. Fast response, no call-out fee, 24/7 availability.",
    "url": siteUrl,
    ...
    "address": {
      ...
      "addressRegion": "Somerset and Wiltshire",
...
export function getLocationPageSchema(location: Location) {
  ...
  const locationSchema = {
    ...
    "areaServed": {
      ...
      "containedInPlace": {
        "@type": "AdministrativeArea",
        "name": location.countyOrRegion || "Somerset and Wiltshire"
      }
    },
    "geo": {
      "@type": "GeoCoordinates",
...
export function getLocationServicePageSchema(location: Location, service: Service) {
  ...
  const serviceSchema = {
    ...
    "description": `Professional ${service.name.toLowerCase()} services in ${location.name}, ${location.countyOrRegion || 'Somerset and Wiltshire'}. Fast response, no call-out fee, 24/7 availability.`,
...
export function getWebSiteSchema() {
  return {
    ...
    "url": siteUrl,
    "name": BRAND.brandName,
    "description": "Professional drain unblocking, CCTV surveys, and emergency drainage services across Bath and Somerset and Wiltshire.",
    "publisher": {
      "@id": `${siteUrl}/#organization`
    },
    "inLanguage": "en-GB",
