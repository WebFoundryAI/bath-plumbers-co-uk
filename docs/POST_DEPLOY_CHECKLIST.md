...
- [x] https://bathplumbers.co.uk/sitemap.xml returns 200
- [x] https://bathplumbers.co.uk/robots.txt returns 200
...
### Validate robots.txt
- [x] Contains `Sitemap: https://bathplumbers.co.uk/sitemap.xml`
...
- [x] Location (`/locations/bath`)
- [x] Location + service (`/locations/bath/blocked-drains`)
- [x] About (`/about`)
- [x] Contact (`/contact`)
...
- [x] Add property: `bathplumbers.co.uk`
...
```bash
# Test sitemap
curl -s https://bathplumbers.co.uk/sitemap.xml | head -20

# Test robots.txt
curl https://bathplumbers.co.uk/robots.txt

# Test homepage canonical
curl -s https://bathplumbers.co.uk/ | grep -i 'rel="canonical"'

# Test homepage title
curl -s https://bathplumbers.co.uk/ | grep -i '<title>'
```
