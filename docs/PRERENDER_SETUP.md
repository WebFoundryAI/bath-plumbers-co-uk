...
This guide walks through setting up Prerender.io to serve fully-rendered HTML to search crawlers for bathplumbers.co.uk.
...
3. Add site: `https://bathplumbers.co.uk`
...
2. Add route: `bathplumbers.co.uk/*`
...
2. Enter: `https://bathplumbers.co.uk/services/blocked-drains`
3. Verify:
...
curl -A "Mozilla/5.0 (compatible; Googlebot/2.1; +http://www.google.com/bot.html)" \
  -I https://bathplumbers.co.uk/services/blocked-drains

# Check if Prerender served the response (via headers)
curl -A "Googlebot" https://bathplumbers.co.uk/ -D -

# View full prerendered HTML
curl -A "Googlebot" https://bathplumbers.co.uk/services/blocked-drains
```
...
curl -X POST https://api.prerender.io/recache \
  ...
  -d '{"prerenderToken": "YOUR_TOKEN", "url": "https://bathplumbers.co.uk/page"}'
```
