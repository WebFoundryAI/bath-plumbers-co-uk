...
2. Add your site URL: `https://bathplumbers.co.uk`
...
2. Enter a URL: `https://bathplumbers.co.uk/services/blocked-drains/`
...
curl -A "Mozilla/5.0 (compatible; Googlebot/2.1; +http://www.google.com/bot.html)" \
  https://bathplumbers.co.uk/services/blocked-drains/
```
