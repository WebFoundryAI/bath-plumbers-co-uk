...
- [ ] Fetch `https://bathplumbers.co.uk/sitemap.xml` - confirm HTTP 200
...
- [ ] Fetch `https://bathplumbers.co.uk/robots.txt` - confirm HTTP 200
...
- [ ] Fetch `https://bathplumbers.co.uk/llm.html` - confirm HTTP 200
...
- [ ] Submit sitemap at `https://bathplumbers.co.uk/sitemap.xml`
